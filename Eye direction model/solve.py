...
data_transforms = {
    'train': transforms.Compose([
        ...
        transforms.RandomPerspective(distortion_scale=0.25, p=0.8, interpolation=InterpolationMode.BILINEAR, fill=0),
...
def getPrediction_old(model,object):
...
def getPrediction(model,object):
    ...
    object['probability'] = conf[0].item()
    object['label'] = class_names[classes.item()]
